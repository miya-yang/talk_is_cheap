<template>
  <div class="initiating-activity-page">
    <h2 class="title">我发起的</h2>
              ...
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    // 废弃活动
                    click: () => {
                      this.$http.post(`?m=activity&c=activity&a=throw_activity`, {
                        activityid: params.row.id
                      }).then(res => {
                        this.$Message.success('活动废弃成功')
                        this.init()
                      })
                    }
                  }
              ...
              return h('div', [
                h('Button', {
                  ...
                  on: {
                    // 参加活动
                    click: () => {
                      this.$http.post(`?m=activity&c=activity&a=finish_activity`, {
                        activityid: params.row.id
                      }).then(res => {
